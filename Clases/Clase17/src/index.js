...
// import orderModel from "./dao/models/order.js";
import studentModel from "./dao/models/students.js";

const enviroment = async() => {
    await mongoose.connect('mongodb+srv://Benjamin:Bastan@codercluster.iwgklyq.mongodb.net/students?retryWrites=true&w=majority'); // Cambiar students por pizzeria
    ...
    let aggregation = await studentModel.aggregate([
        {
